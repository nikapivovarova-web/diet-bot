...
FOOD_DEFS: tuple[FoodDef, ...] = (
    ...
    fd("american_cheese", "плавленый сыр в ломтиках", "cheese pasteurized process American", "dairy", ("плавленый сыр в ломтиках",), tags=("lactose", "high_sodium"), roles=("protein", "calcium"), gram_per_slice=20, max_per_meal_g=80, max_per_day_g=120),
...
EXTRA_FOOD_DEFS: tuple[FoodDef, ...] = (
    ...
    fd("ground_meat", "говяжий фарш", "beef ground 90% lean meat 10% fat raw", "protein", ("сбульонй фарш",), roles=("protein",), max_per_meal_g=220, max_per_day_g=320),
