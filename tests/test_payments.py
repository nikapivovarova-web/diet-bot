...
@pytest.mark.parametrize(
    ...
    [
        (
            PROVIDER_TELEGRAM_STARS,
            PRODUCT_SUBSCRIPTION_MONTH,
            PaymentProductPrice(amount=400, currency="XTR"),
        ),
        (PROVIDER_TELEGRAM_STARS, PRODUCT_EXTRA_ONE_DAY, PaymentProductPrice(amount=35, currency="XTR")),
        (
            PROVIDER_TELEGRAM_STARS,
            PRODUCT_EXTRA_WEEKLY_PDF,
            PaymentProductPrice(amount=170, currency="XTR"),
        ),
        (PROVIDER_YOOKASSA, PRODUCT_SUBSCRIPTION_MONTH, PaymentProductPrice(amount=59_900, currency="RUB")),
