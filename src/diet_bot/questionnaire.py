...
QUESTIONS: tuple[Question, ...] = (
    ...
    Question("sex", "Ваш пол? Напишите: мужчина или женщина."),
    Question("height_cm", "Ваш рост в сантиметрах? Например: 178."),
    Question("weight_kg", "Ваш вес в килограммах? Например: 86."),
    Question("goal", "Какая цель? Напишите: похудение, поддержание или набор."),
    Question(
        "activity",
        "Активность: сидячая, легкая, умеренная, высокая или очень высокая?",
    ),
    Question("meal_count", "Сколько приемов пищи в день: 3, 4 или 5?"),
    Question(
        "allergies",
